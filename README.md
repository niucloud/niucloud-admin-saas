...
1.niucloud-admin软件开发框架采用Saas多站点，多用户，多租户模式研发，框架内置各种基础功能，可大量节省SaaS系统开发周期，快速完成交付。

2.采用Saas架构底层设计，支持无限账号，无需重复部署安装，高效管理多个用户，多个应用。

3.niucloud-admin软件开发框架内置插件管理机制，支持第三方开发者参与开发各种功能插件，独特的软件插件架构设计，支持多插件并存，即便二次开发之后，也不会影响与主框架同步无缝升级。

4.niucloud-admin软件开发框架内置集成Saas多站点、多租户套餐、用户权限、代码生成器、表单设计、云存储、短信发送、素材中心、微信及公众号、支付宝小程序、Api模块一系列开箱即用功能，是一款快速可以开发企业级应用的软件系统。

5.niucloud-admin软件开发框架支持在线更新，可统一管理主框架及各种插件的在线安装，在线更新。
