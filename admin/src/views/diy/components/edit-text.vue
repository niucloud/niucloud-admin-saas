<template>
	<div class="edit-text">
		...
		<div class="border-solid border-b-4 border-gray-200 mb-[20px]">
			...
			<el-form label-width="80px" class="px-[10px]">
				<el-form-item :label="t('title')">
					<el-input v-model="diyStore.editComponent.text" :placeholder="t('titlePlaceholder')"
					          clearable
		...
		<div class="border-solid border-b-4 border-gray-200 mb-[20px]" v-show="diyStore.editComponent.subTitle.control">
			<h3 class="mb-[10px]">{{ t('subTitleContent') }}</h3>
			<el-form label-width="80px" class="px-[10px]">
				<el-form-item :label="t('subTitle')">
					<el-input v-model="diyStore.editComponent.subTitle.text"
					          :placeholder="t('subTitlePlaceholder')" clearable
		...
		<div class="border-solid border-b-4 border-gray-200 mb-[20px]" v-show="diyStore.editComponent.more.control">
			<h3 class="mb-[10px]">{{ t('moreContent') }}</h3>
			<el-form label-width="80px" class="px-[10px]">
				<el-form-item :label="t('more')">
					<el-input v-model="diyStore.editComponent.more.text" :placeholder="t('morePlaceholder')"
					          clearable
	...
	<el-dialog v-model="showDialog" :title="t('selectStyle')" width="40%">
		...
		<div class="flex flex-wrap">
			<div class="flex items-center justify-center overflow-hidden w-[280px] h-[100px] mr-[12px] cursor-pointer border bg-gray-50"
			     :class="{ 'border-primary' : selectStyle == 'style-1'}"
			     @click="selectStyle = 'style-1'">
				<img class="max-w-[280px] max-h-[220px]" src="@/assets/images/diy/text/style1.png"/>
			</div>
			<div class="flex items-center justify-center overflow-hidden w-[280px] h-[100px] mr-[12px] cursor-pointer border bg-gray-50"
			     :class="{ 'border-primary' : selectStyle == 'style-2'}"
			     @click="selectStyle = 'style-2'">
