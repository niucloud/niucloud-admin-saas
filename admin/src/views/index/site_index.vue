    ...
    <div class="main-container flex" v-loading="loading">
        ...
        <div class="main-aside w-[300px]">
            <el-card class="box-card !border-none" shadow="never">
                <template #header>
                    <div class="card-header">
                        <span class="text-[14px]">{{t('siteInfo')}}</span>
                    </div>
                </template>
                <el-descriptions :column="1">
                    <el-descriptions-item :label="t('siteName')">{{statInfo.site_info.site_name}}</el-descriptions-item>
                    <el-descriptions-item :label="t('groupName')">{{ statInfo.site_info.group_name }}</el-descriptions-item>
                    <el-descriptions-item :label="t('statusName')">{{ statInfo.site_info.status_name }}</el-descriptions-item>
                    
                    <el-descriptions-item :label="t('expireTime')">{{ statInfo.site_info.expire_time ? statInfo.site_info.expire_time : t('permanent')}}</el-descriptions-item>
                </el-descriptions>
            </el-card>
...
let statInfo = ref({'today_data':{},system:{},version:{},about:[],visit_stat:{},member_stat:{},site_info:{}})
