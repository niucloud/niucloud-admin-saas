...
import { t } from '@/lang'
import { getChangeTypeList,getMoneyList } from '@/api/member'
import { img } from '@/utils/common'
import moneyInfo from '@/views/member/components/member-money-info.vue'
...
const setFromTypeList = async () => {
    fromTypeList.value = await (await getChangeTypeList('money')).data
}
