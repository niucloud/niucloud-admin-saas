        ...
        <el-card class="box-card !border-none" shadow="never">
            ...
            <el-card class="box-card !border-none my-[16px] table-search-wrap" shadow="never">
                <el-form :inline="true" :model="siteTableData.searchParam" ref="searchFormRef">
                    ...
                    <el-form-item :label="t('groupId')" prop="group_id">
                        <el-select v-model="siteTableData.searchParam.group_id" clearable :placeholder="t('groupIdPlaceholder')"
                            class="input-width">
            ...
            <div class="mt-[16px]">
                <el-table :data="siteTableData.data" size="large" v-loading="siteTableData.loading">
                    ...
                    <el-table-column prop="site_name" :label="t('siteName')" min-width="120" :show-overflow-tooltip="true"/>
                    <el-table-column prop="group_name" :label="t('groupId')" min-width="120" :show-overflow-tooltip="true"/>
...
const infoEvent = (data: any) => {
    router.push('/site/info?id='+data.site_id)
}
