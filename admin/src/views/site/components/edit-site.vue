<template>
    <el-dialog v-model="showDialog" :title="elDialogTitile" width="500px"
...
import { addSite,getSiteGroupAll,getSiteInfo,updateSite } from '@/api/site';
...
const confirm = async (formEl: FormInstance | undefined) => {
    ...
    await formEl.validate(async (valid) => {
        if (valid) {
            ...
            let data = formData
            let save = data.site_id ? updateSite : addSite
            save(data).then(res => {
                loading.value = false
