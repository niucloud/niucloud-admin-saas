		...
		<div class="main-body flex-1 mr-[15px]">
			...
			<el-card class="box-card !border-none mt-[15px]" shadow="never">
				<el-row justify="space-between">
					<el-col :span="4">
						<div class="w-[120px]  2xl:w-[200px]  py-[15px] rounded-[10px] flex justify-center items-center cursor-pointer border-[1px] border-[#E5E8EE]"
							@click="toLink('/article/list')">
							<img class="w-[33px]" src="@/app/assets/images/index/article.png" />
							<span class="ml-[10px] text-[16px] text-[#666]">{{ t('articleList') }}</span>
						</div>
					</el-col>
					<el-col :span="4">
						<div class="w-[120px]  2xl:w-[200px]  py-[15px] rounded-[10px] flex justify-center items-center cursor-pointer border-[1px] border-[#E5E8EE]"
							@click="toLink('/member/member')">
							<img class="w-[33px]" src="@/app/assets/images/index/site_member.png" />
							<span class="ml-[10px] text-[16px] text-[#666]">{{ t('memberManagement') }}</span>
						</div>
					</el-col>
					<el-col :span="4">
						<div class="w-[120px]  2xl:w-[200px]  py-[15px] rounded-[10px] flex justify-center items-center cursor-pointer border-[1px] border-[#E5E8EE]"
							@click="toLink('/member/balance')">
							<img class="w-[33px]" src="@/app/assets/images/index/site_balance.png" />
					...
					<el-col :span="4">
						<div class="w-[120px]  2xl:w-[200px]  py-[15px] rounded-[10px] flex justify-center items-center cursor-pointer border-[1px] border-[#E5E8EE]"
							@click="toLink('/member/member')">
							<img class="w-[33px]" src="@/app/assets/images/index/site_auth.png" />
							<span class="ml-[10px] text-[16px] text-[#666]">{{ t('administrator') }}</span>
						</div>
					</el-col>
					<el-col :span="4">
						<div class="w-[120px]  2xl:w-[200px]  py-[15px] rounded-[10px] flex justify-center items-center cursor-pointer border-[1px] border-[#E5E8EE]"
							@click="toLink('/diy/index')">
							<img class="w-[33px]" src="@/app/assets/images/index/renovation.png" />
			...
			<el-card class="box-card !border-none" shadow="never">
				...
				<div class="site-info w-[260px] h-[150px] pl-[20px] pt-[20px] pb-[10px] pr-[15px]">
					<div class="flex items-end justify-between">
						<div>
							<div class="flex">
								<icon name="iconfont-iconhuangjinhuiyuan0101-copy" class="leading-[1] mr-[5px]" size="22px"
									color="#2934DD"></icon><span class="text-[#2934DD] text-[16px] font-bold ">{{
										statInfo.site_info.group_name }}</span>
							</div>
							<div><span class="text-[#3C45A5] text-[12px]">{{ t('siteName') }}：{{
								statInfo.site_info.site_name }}</span></div>
						</div>
						<span @click="renew"
							class="cursor-pointer w-[70px] h-[30px] text-center leading-[30px] bg-[#2C3EEF] text-[#fff] text-[14px] rounded-[5px]">续费</span>
					</div>
					<i class="block w-[30px] h-[4px] bg-[#2934DD] mt-[6px] mb-[18px]"></i>
					<div>
						<div><span class="text-[#3C45A5] text-[12px]">{{ t('statusName') }}：{{
							statInfo.site_info.status_name }}</span></div>
						<div><span class="text-[#3C45A5] text-[12px]">{{ t('expireTime') }}：{{
							statInfo.site_info.expire_time ? statInfo.site_info.expire_time : t('permanent') }}</span>
						</div>
					</div>
				</div>
			</el-card>
			...
			<el-card class="box-card !border-none mt-[15px]" shadow="never">
				...
				<div>
					...
					<div v-else class="flex items-center pt-[10px] pb-[25px]">
						<img class="w-[120px] h-[120px] mr-[8px]" src="@/app/assets/images/index/wx_qrcode.jpg" alt="">
						<div>
					...
					<div class="flex items-center pt-[25px] pb-[30px] border-gray-300 border-b-[1px]"
						v-if="serviceData.enterprise_wechat">
					...
					<div v-else class="flex items-center pt-[25px] pb-[30px] border-gray-300 border-b-[1px]">
						<img class="w-[120px] h-[120px] mr-[8px]" src="@/app/assets/images/index/wework_qrcode.png" alt="">
						<div>
...
import { t } from '@/lang'
import { getSiteStatInfo } from '@/app/api/stat'
import { getService } from '@/app/api/sys'
...
const statInfo = ref<{
	...
	version: AnyObject,
	about: AnyObject,
	visit_stat: AnyObject,
	member_stat: AnyObject,
	site_info: AnyObject,
	total_data: AnyObject
}>({ today_data: {}, system: {}, version: {}, about: [], visit_stat: {}, member_stat: {}, site_info: {}, total_data: {} })
...
const drawChart = () => {
    ...
    const memberStatOption: AnyObject = ref({
        legend: {},
        tooltip: {},
        series: [
            {
